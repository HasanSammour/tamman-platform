...
@section('title', __('Create Content') . ' - ' . __('Tamman'))

@section('page-title', __('Create New Content'))

@section('content')
    <div class="content-create-wrapper">
        <!-- Breadcrumb -->
        <div class="breadcrumb-nav animate-fade-in">
            ...
            <i class="fas fa-chevron-right breadcrumb-sep"></i>
            <span class="breadcrumb-current">{{ __('Create Content') }}</span>
        </div>
        ...
        <div class="form-card animate-slide-up">
            <div class="form-header">
                ...
                <div class="header-text">
                    <h2>{{ __('Create New Content') }}</h2>
                    <p>{{ __('Add articles, videos, tips, or guides to help users') }}</p>
                </div>
            </div>

            <form id="contentForm" class="content-form" method="POST" action="{{ route('admin.content.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="title" id="title" class="form-control"
                            placeholder="{{ __('Enter content title...') }}" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div id="editorToolbar" class="editor-toolbar">
                        ...
                        <div class="dropdown headings-dropdown">
                            <button type="button" class="dropdown-toggle" id="headingsDropdownBtn" title="{{ __('Headings') }}">
                                <i class="fas fa-heading"></i> <span>{{ __('H') }}</span> <i class="fas fa-chevron-down"></i>
                            </button>
                ...
                <div class="form-group">
                    ...
                    <div class="status-toggle">
                        <div class="toggle-option draft selected" data-status="draft">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-submit" id="submitBtn">
                        <span class="btn-text"><i class="fas fa-save"></i> {{ __('Create Content') }}</span>
                        ...
                        if (data.success) {
                            ...
                            if (data.errors) {
                                ...
                                await Swal.fire({
                                    icon: 'error',
                                    title: '{{ __("Error!") }}',
                                    text: data.message || '{{ __("Failed to create content") }}',
                                    confirmButtonColor: '#7c3aed'
                                });
                            }
                        }
